...
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **Содержательность и релевантность**              | Презентация соответствует заявленной теме, включает корректное использование ключевых понятий дисциплины и демонстрирует освоение учебного материала.                                                                                               | 5          |
| **Лаконичность и структурированность**            | Выступление укладывается в установленный временной регламент (3–5 минут) и имеет логически выстроенную структуру: введение, основная часть, заключение.                                                                                             | 3          |
| **Ясность и культура речи**                       | Речь отличается ясностью, последовательностью изложения и корректным использованием терминологического аппарата дисциплины.                                                                                                                         | 2          |
| **Использование примеров и критического взгляда** | Презентация содержит обоснованное применение примеров (программное обеспечение, форматы данных, проектные решения) и демонстрирует способность к сравнительному анализу технологий с учётом их функциональных, этических и ресурсных характеристик. | 2          |
